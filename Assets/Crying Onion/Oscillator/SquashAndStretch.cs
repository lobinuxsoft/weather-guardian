...
namespace CryingOnion.OscillatorSystem
{
    ...
    public class SquashAndStretch : MonoBehaviour
    {
        ...
        private Vector3 localEquilibriumScale;
        ...
        /// </summary>
        private void Start() => localEquilibriumScale = transform.localScale;

        /// <summary>
        /// Updates the local scale to be the squashed and stretched scale.
        /// </summary>
        private void FixedUpdate() => transform.localScale = CalculateSquashedAndStretchedScale();
        ...
        private Vector3 CalculateSquashedAndStretchedScale()
        {
            ...
            Vector3 localScale = localEquilibriumScale + oscillatorContribution;
            return localScale;
        }
